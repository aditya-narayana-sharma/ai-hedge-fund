...
from src.data.portfolio import DEFAULT_POSITION_LIMIT, net_liquidation_value
...
def risk_management_agent(state: AgentState):
    ...
    position_limit_pct = state["metadata"].get("position_limit", DEFAULT_POSITION_LIMIT)
    ...
    # Net Liquidation Value, from the one shared implementation.
